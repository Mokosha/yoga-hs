...
static YGMalloc gYGMalloc = &malloc;
static YGCalloc gYGCalloc = &calloc;
static YGRealloc gYGRealloc = &realloc;
static YGFree gYGFree = &free;
...
YGMalloc YGGetMalloc() { return gYGMalloc; }
YGCalloc YGGetCalloc() { return gYGCalloc; }
YGRealloc YGGetRealloc() { return gYGRealloc; }
YGFree YGGetFree() { return gYGFree; }
